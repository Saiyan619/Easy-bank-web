  ...
  return (
    <div className='p-3  bg-white'>
        ...
        <ul className={`${Overlay ? 'hidden' : ''} rounded-lg text-xl gap-2 z-50 w-full h-60 flex items-center justify-center flex-col list-none absolute top-10 bg-gray-100 text-center md:top-0 md:relative  md:flex-row  md:w-full md:h-0  md:flex md:gap-5`}>
              ...
              <div>
          <img className='cursor-pointer md:hidden' onClick={toggleNav} src={Overlay ? "/src/assets/easybank-landing-page-master/easybank-landing-page-master/images/icon-hamburger.svg" : "/src/assets/easybank-landing-page-master/easybank-landing-page-master/images/icon-close.svg"} alt="" />
